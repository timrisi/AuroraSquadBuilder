		...
		public Pilot SelectedPilot {
			...
			set { 
				...
				if (value != null) {
					...
					NavigationService.PopAsync (true).ContinueWith (t => Console.WriteLine (t.Exception), System.Threading.Tasks.TaskContinuationOptions.OnlyOnFaulted); // <PilotsListViewModel> (this);
				}
			}
		}
